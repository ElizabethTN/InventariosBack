...
try {
    ...
    $stmt = $databaseConnection->prepare("INSERT INTO multifuncionales (numSerie, rpeCapturador, rpeResponsable, fecha, nombreDivision, nombreZona, estado, marca, modelo, ip, requiereMantenimiento, descripcionMantenimiento) VALUES (:numSerie, :rpeCapturador, :rpeResponsable, :fecha, :nombreDivision, :nombreZona, :estado, :marca, :modelo, :ip, :requiereMantenimiento, :descripcionMantenimiento)");
