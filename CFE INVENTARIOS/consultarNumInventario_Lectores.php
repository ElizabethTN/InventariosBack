...
$databaseConnection->exec("SET NAMES utf8");
    try
    {
        ...
        $stmt = $databaseConnection->prepare("SELECT * FROM lectoresopticos WHERE numInventario = :numInventario");
        ...
        if ($vehiculo) {
            ...
            echo json_encode(array('mensaje' => 'lector optico no encontrado'));
        }
    } 
